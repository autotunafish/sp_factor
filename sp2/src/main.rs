...
fn main() {
    ...
    if z0vektor[2] == 0 {
        ...
        //29x19
        {
            ...
            //This is the 29x19 so two matches
            for i in LMOD29ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD29ARR[lupval], &LMOD19ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD29ARR[ldnval], &LMOD19ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //1x11
        {
            ...
            //This is the 1x11 so two matches
            for i in LMOD1ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD1ARR[lupval], &LMOD11ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD1ARR[ldnval], &LMOD11ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //17x13
        {
            ...
            //This is the 17x13 so two matches
            for i in LMOD17ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD17ARR[lupval], &LMOD13ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD17ARR[ldnval], &LMOD13ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //7x23
        {
            ...
            //This is the 7x23 so two matches
            for i in LMOD7ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD7ARR[lupval], &LMOD23ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD7ARR[ldnval], &LMOD23ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
    ...
    if z0vektor[3] == 0 {
        ...
        //7x19
        {
            ...
            //This is the 7x19 so two matches
            for i in LMOD7ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD7ARR[lupval], &LMOD19ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD7ARR[ldnval], &LMOD19ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //23x11
        {
            ...
            //This is the 23x11 so two matches
            for i in LMOD23ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD23ARR[lupval], &LMOD11ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD23ARR[ldnval], &LMOD11ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //1x13
        {
            ...
            //This is the 1x13 so two matches
            for i in LMOD1ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD1ARR[lupval], &LMOD13ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD1ARR[ldnval], &LMOD13ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //29x17
        {
            ...
            //This is the 29x17 so two matches
            for i in LMOD29ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD29ARR[lupval], &LMOD17ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD29ARR[ldnval], &LMOD17ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
