...
fn main() {
    ...
    if z0vektor[6] == 0 {
        ...
        //7x29
        {
            ...
            //This is the 7x29 so two matches
            for i in LMOD29ARR {
                j = i.into();
            ...
            loop {
                ...
                let chkval2: u128 = LMOD7ARR[rdnval].clone().into();
                let chkval: u128 = chkval1 * chkval2;

                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD29ARR[lupval], &LMOD7ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if rupval > LMOD7ARR.len() - 1 {
                    break;
                }

                let chkval1: u128 = LMOD29ARR[ldnval].clone().into();
                let chkval2: u128 = LMOD7ARR[rupval].clone().into();
                let chkval: u128 = chkval1 * chkval2;

                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD29ARR[ldnval], &LMOD7ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //1x23
        {
            ...
            //This is the 1x23 so two matches
            for i in LMOD1ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD1ARR[lupval], &LMOD23ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD1ARR[ldnval], &LMOD23ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //11x13
        {
            ...
            //This is the 11x13 so two matches
            for i in LMOD11ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD11ARR[lupval], &LMOD13ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD11ARR[ldnval], &LMOD13ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //17x19
        {
            ...
            //This is the 17x19 so two matches
            for i in LMOD17ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD17ARR[lupval], &LMOD19ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD17ARR[ldnval], &LMOD19ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
    ...
    if z0vektor[7] == 0 {
        ...
        //11x19
        {
            ...
            //This is the 11x19 so two matches
            for i in LMOD11ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD11ARR[lupval], &LMOD19ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD11ARR[ldnval], &LMOD19ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //23x13
        {
            ...
            //This is the 23x13 so two matches
            for i in LMOD23ARR {
                j = i.into();
            ...
            loop {
                ...
                if lupval > LMOD23ARR.len() - 1 {
                    break;
                }

                let chkval1: u128 = LMOD23ARR[lupval].clone().into();
                let chkval2: u128 = LMOD13ARR[rdnval].clone().into();
                let chkval: u128 = chkval1 * chkval2;
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD23ARR[lupval], &LMOD13ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                let chkval1: u128 = LMOD23ARR[ldnval].clone().into();
                let chkval2: u128 = LMOD13ARR[rupval].clone().into();
                let chkval: u128 = chkval1 * chkval2;
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD23ARR[ldnval], &LMOD13ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //1x29
        {
            ...
            //This is the 1x29 so two matches
            for i in LMOD1ARR {
                j = i.into();
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD1ARR[lupval], &LMOD29ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD1ARR[ldnval], &LMOD29ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
        ...
        //7x17
        {
            ...
            //This is the 7x17 so two matches
            for i in LMOD7ARR {
                j = i.into();
            ...
            loop {
                ...
                let chkval2: u128 = LMOD17ARR[rdnval].clone().into();
                let chkval: u128 = chkval1 * chkval2;

                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD7ARR[lupval], &LMOD17ARR[rdnval]
                    );
                    break;
                }
                if chkval > height.try_into().unwrap() {
            ...
            loop {
                ...
                if rupval > LMOD17ARR.len() - 1 {
                    break;
                }

                let chkval1: u128 = LMOD7ARR[ldnval].clone().into();
                let chkval2: u128 = LMOD17ARR[rupval].clone().into();
                let chkval: u128 = chkval1 * chkval2;

                if chkval == height.try_into().unwrap() {
                    println!(
                        "******************\n--result-> {:?} x {:?}\n***************",
                        &LMOD7ARR[ldnval], &LMOD17ARR[rupval]
                    );
                    break;
                }
                if chkval < height.try_into().unwrap() {
